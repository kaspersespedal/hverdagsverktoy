...
window.renderSiteChrome = function(opts){
  ...
  const tabDefs = [
    ...
    {k:'kalkulator',l:'Kalkulator',    svg:'<rect x="5" y="3" width="14" height="18" rx="2"/><rect x="8" y="6" width="8" height="3" rx="0.5"/><rect x="7.7" y="11.5" width="2.6" height="2.6" rx="0.4"/><rect x="10.7" y="11.5" width="2.6" height="2.6" rx="0.4"/><rect x="13.7" y="11.5" width="2.6" height="2.6" rx="0.4"/><rect x="7.7" y="15.4" width="2.6" height="2.6" rx="0.4"/><rect x="10.7" y="15.4" width="2.6" height="2.6" rx="0.4"/><rect x="13.7" y="15.4" width="2.6" height="2.6" rx="0.4"/>'},
    {k:'skatt',     l:'Skatt',         svg:'<path d="M7 3 H14 L18 7 V21 H7 Z"/><path d="M14 3 V7 H18"/><line x1="10" y1="12" x2="15" y2="12"/><line x1="10" y1="15" x2="15" y2="15"/><line x1="10" y1="18" x2="13" y2="18"/>'},
    {k:'selskap',   l:'Selskap',       svg:'<rect x="5" y="3" width="14" height="18" rx="1"/><rect x="8" y="6.5" width="2.4" height="2.4" rx="0.3"/><rect x="13.6" y="6.5" width="2.4" height="2.4" rx="0.3"/><rect x="8" y="11" width="2.4" height="2.4" rx="0.3"/><rect x="13.6" y="11" width="2.4" height="2.4" rx="0.3"/><path d="M10 21 V16.5 H14 V21"/>'},
