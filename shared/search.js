...
var SEARCH_DATA = [
  ...
  {name:'Ansattkostnad (AGA)',desc:'Beregn total årskostnad for en ansatt inkl. AGA og OTP',url:'/kalkulator/#aga',tags:'ansattkostnad aga arbeidsgiveravgift otp pensjon feriepenger lønn kostnad ansatt arbeidsgiver employee cost',type:'tool',page:'Kalkulator',sk:'aga'},
  ...
  {name:'Egenkapital',desc:'Minimumskapital du må ha ved boligkjøp (15%)',url:'/boliglan/',tags:'egenkapital 15 prosent boligkjøp krav bank equity down payment',type:'concept',page:'Boliglån',sk:'egenkapital'},
  {name:'BSU — Boligsparing for ungdom',desc:'Skattefradrag på 20% av innskudd, maks 27 500 kr/år',url:'/boliglan/#mor-bsu-card',tags:'bsu boligsparing ungdom skattefradrag 20 prosent sparing bolig housing savings',type:'concept',page:'Boliglån',sk:'bsu'},
  ...
  {name:'OTP — Obligatorisk tjenestepensjon',desc:'Arbeidsgiver må spare minst 2% av lønn over 1G til pensjon',url:'/kalkulator/#aga',tags:'otp obligatorisk tjenestepensjon arbeidsgiver 2 prosent 1g pensjon mandatory pension',type:'concept',page:'Kalkulator',sk:'otp'},
  {name:'Arbeidsgiveravgift (AGA)',desc:'Avgift arbeidsgiver betaler på lønn — varierer etter sone',url:'/kalkulator/#aga',tags:'arbeidsgiveravgift aga sone avgift arbeidsgiver lønn 14.1 employer tax',type:'concept',page:'Kalkulator',sk:'agaBegrep'},
